var sukanteditor = angular.module('sukanteditor', []);

sukanteditor.config(function($interpolateProvider) {
  $interpolateProvider
    .startSymbol('{[')
    .endSymbol(']}');
});

sukanteditor.directive('bindValueTo', function() {
  return {
    restrict: 'A',
...
sukanteditor.directive('objectButtonsEnabled', function() {
  return {
    restrict: 'A',
