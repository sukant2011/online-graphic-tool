...
function setActiveProp(name, value) {
  ...
  //object.set('originX', value).setCoords();
  canvas.renderAll();
}
...
function addAccessors($scope) {
  ...
  $scope.isTextStyle = function(value) {


    return getActiveStyle('textAlign')==value;
  }; 
  ...
  $scope.addText = function() {
    ...
    var textSample = new fabric.IText(text, {
      left: getRandomInt(350, 400)/2,
      top: getRandomInt(350, 400)/2,
...
sukanteditor.controller('CanvasControls', function($scope) {
