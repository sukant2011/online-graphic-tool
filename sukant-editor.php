<html lang="en" ng-app="sukanteditor">
 
  

    <title>Sukant Editor</title>
    <head>
      ...
      <script src="js/paster.js" type="text/javascript"></script>
  ...
  <body>
    ...
    <div class="container" id="bd-wrapper" ng-controller="CanvasControls">
       <div id="mainContainer">
         <h2>Online Graphic tool</h2>
        <div id="innerContainer">
          <div class="leftBlk">
             <h3>Tools</h3> 
            <i class="fa fa-font fsize24" data-toggle="tooltip" title="Add Text" ng-click="addText()"></i>
            <i class="fa fa-close" data-toggle="tooltip" title="Delete Object" ng-click="removeSelected()"></i>   
          </div>  
          <div class="centerBlk">
               <div style="position:relative;width:530px;float:left;" id="canvas-wrapper">
                ...
                <canvas id="canvas" width="530" height="469"></canvas>
          ...
          <div class="rightBlk">
              ...
              <!--<div id="color-opacity-controls" ng-show="canvas.getActiveObject()">
               ...
               <div id="text-wrapper" style="margin-top: 10px" ng-show="getText()">
                  ...
                  <div class="col-lg-12">                    
                    <label>Add Text: </label><textarea bind-value-to="text"></textarea>
                  </div>  
                 
                  <div  class="col-lg-12">
                    <div class="toolbar-option toolbar-radio" data-option-type="text-align" data-number-of-items="4">
                      <h4 class="toolbar-option-label">Text Alignment</h4>
                      <div class="toolbar-radio-inner">
                        <div data-value="left" class="toolbar-radio-item"  ng-class="{'selected': isTextStyle('left')}" ng-click="setTextAlign('left')" >
                          <i class="fa fa-align-left fsize24" data-toggle="tooltip" title="Add Text" ></i>
                        </div>
                        <div data-value="center" class="toolbar-radio-item" ng-class="{'selected': isTextStyle('center')}" ng-click="setTextAlign('center')">
                          <i class="fa fa-align-center fsize24" data-toggle="tooltip" title="Add Text" ></i>
                        </div>
                        <div data-value="right" class="toolbar-radio-item" ng-class="{'selected': isTextStyle('right')}" ng-click="setTextAlign('right')">
                          <i class="fa fa-align-right fsize24" data-toggle="tooltip" title="Add Text"  ></i>
                        </div>
                        <div data-value="justify" class="toolbar-radio-item" ng-class="{'selected': isTextStyle('justify')}" ng-click="setTextAlign('justify')">
                          <i class="fa fa-align-justify" data-toggle="tooltip" title="Add Text"  ></i>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div  class="col-lg-12 margin10">
                      ...
                      <div class="col-lg-6 padding0">
                        ...
                        <input type="color" value="" id="text-bg-color" size="10" class="btn-object-action fullWidth"
                    ...
                    <div  class="col-lg-12 margin10 textBStyle">
                      <div class="btn-group">
                        <a href="javascript:void(0)" class="btn btn-default" title="Bold" style="cursor: pointer;" ng-click="toggleBold()" ng-class="{'active': isBold()}"><i class="fa fa-bold"></i></a>
                        <a href="javascript:void(0)" class="btn btn-default" title="Italics" style="cursor: pointer;" ng-click="toggleItalic()" ng-class="{'active': isItalic()}"><i class="fa fa-italic"></i></a>
                        <a href="javascript:void(0)" class="btn btn-default" title="Underline" style="cursor: pointer;"  ng-click="toggleUnderline()" ng-class="{'active': isUnderline()}"><i class="fa fa-underline"></i></a>
                        <a href="javascript:void(0)" class="btn btn-default" title="Strikethrough" style="cursor: pointer;" ng-click="toggleLinethrough()" ng-class="{'active': isLinethrough()}"><i class="fa fa-strikethrough"></i></a>
...
<script src="js/app_config.js" type="text/javascript"></script>
